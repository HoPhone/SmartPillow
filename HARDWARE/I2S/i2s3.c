...
{ 
	...
	/*
	PB3:SCLK,PB4:SDOUT,PB5:SDIN,PA4:LRCK,PC7:MCLK
	*/
	...
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource3, GPIO_AF_SPI3); //I2S3_CK---BCLK 
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource4, GPIO_AF7_SPI3);  //I2S3ext_SD---ADCDAT	
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource5, GPIO_AF_SPI3);	// I2S3_SD---DACDAT
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource4, GPIO_AF_SPI3);	 // I2S3_WS---RCK
	GPIO_PinAFConfig(GPIOC, GPIO_PinSource7, GPIO_AF_SPI3);	//I2S3_MCK---MCLK
	...
	SPI_I2S_DMACmd(SPI3, SPI_I2S_DMAReq_Tx, ENABLE);//SPI3_TX DMA请求使能.
