...
u8 My_RTC_Init(void)
{
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_PWR, ENABLE);//使能PWR时钟
    ...
    RTC_Init(&RTC_InitStructure);
		...
		RTC_Set_Time(15,46,40,RTC_H12_AM);	//设置时间
		RTC_Set_Date(17,5,26,5);		//设置日期
...
{ 
   ...
   //RTC_AlarmTypeInitStructure.RTC_AlarmMask=RTC_AlarmMask_None;//精确匹配星期，时分秒
	 RTC_AlarmTypeInitStructure.RTC_AlarmMask= RTC_AlarmMask_DateWeekDay;//忽略日期和星期，即每一天都响
