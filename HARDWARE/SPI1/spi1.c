...
{	 
	...
	//SPI1_WriteBytes(0xffff);//启动传输		 
}   
/*
在SPI1_Init函数里面，把SPI1的频率设置成了最低（84Mhz，256分频）。在外部函数里
面，我们通过SPI1_SetSpeed 来设置SPI1 的速度，
*/

//SPI1速度设置函数
//SpeedSet:0~7
//有SPI_BaudRatePrescaler_2到SPI_BaudRatePrescaler_256，共8个。
...
{  
	...
	//{
	//}//等待发送区空  		
	//SPI_I2S_SendData(SPI1, TxData>>8); 
